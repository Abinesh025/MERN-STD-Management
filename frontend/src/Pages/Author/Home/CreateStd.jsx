...
const CreateStudent = () => {
  ...
  const {mutate} = useMutation({
      mutationFn:async({StudentName,RegNum,Email,PhoneNum})=>{
        try
        {
          const res = await fetch(`${baseUrl}/api/student/details`,{
            method:"POST",
            credentials:"include",
            headers:{
            ...
            body:JSON.stringify({StudentName,RegNum,Email,PhoneNum})
          })
