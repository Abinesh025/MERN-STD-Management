...
const Signup = () => {
  ...
  const {mutate} = useMutation({
      mutationFn:async({User,Dept,Password})=>{
        try
        {
          const res = await fetch(`${baseUrl}/api/auther/signup`,{
            ...
            body:JSON.stringify({User,Dept,Password})
          })
  ...
  return (
    <div >
            ...
            <form className="flex w-full flex-col max-w-96 focus:ring-indigo-600" onSubmit={handleSubmit}>
                ...
                <a href="https://prebuiltui.com" className="mb-5" title="Go to PrebuiltUI">
                ...
                <h2 className="text-4xl font-medium text-white-900">Sign in</h2>
